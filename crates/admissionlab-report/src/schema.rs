//! JSON Schema generation for the frozen `v1beta1` result document.
//!
//! ROADMAP Task 7.2 publishes `schemas/result-v1beta1.json` next to the
...
//! # Determinism
//!
//! [`result_v1beta1_json_schema`] produces byte-for-byte identical
...
/// Generates the JSON Schema for the frozen
/// `admissionlab.io/result/v1beta1` result document.
///
...
#[must_use]
pub fn result_v1beta1_json_schema() -> Schema {
